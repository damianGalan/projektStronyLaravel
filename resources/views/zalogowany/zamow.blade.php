...
<div id="menu">
    ...
    <h1 class="tytul">Formularz zamowienia</h1><br/><br/>

    <form action="{{route('Sites.save')}}" method="post">
        <input type="hidden" name="_token" value="{{csrf_token()}}">
        <div class="form-group">
            <input type="text" name="osoba" placeholder="Podaj imię i nazwisko" class="formul">
        </div>

        <div class="form-group">
            <input type="text" name="adres" placeholder="Podaj adres" class="formul">
        </div>

        <div class="form-group">
            <input type="text" name="numer" placeholder="Podaj numer telefonu" class="formul">
        </div>
        <div class="form-group">
