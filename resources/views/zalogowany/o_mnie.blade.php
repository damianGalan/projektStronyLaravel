...
<head>
    ...
    <!-- Styles -->
    <link rel="stylesheet" href="css/omnie.css" />
</head>
<body>
<div id="app">
...
<div id="menu">
    ...
    <h1 class="tytul">Zmiana hasła</h1><br/><br/>

    <form action="{{route('Users.zmien')}}" method="post">
        <input type="hidden" name="_token" value="{{csrf_token()}}">
        <div class="form-group">
            <input type="text" name="prev" placeholder="Podaj stare hasło" class="formul">
        </div>

        <div class="form-group">
            <input type="text" name="new" placeholder="Podaj nowe hasło" class="formul">
        </div>

        <div class="form-group" class="formul">
            <input type="text" name="repeatNew" placeholder="Powtórz nowe hasło" class="formul">
        </div>
        <div class="form-group" class="formul">
            <button class="btn btn-primary" class="formul">Zapisz</button>
        </div>
    </form>
